...
@section('content-section')
    <div class="container offres">
        <div class="page-inner">
            <a href="{{ route('recruteurs.offres.create') }}" class="btn-click">Creer une offre</a>
                            ...
                            <div class="row">
                                <div class="col-10">
                                    ...
                                    <h3 class="post-category text-upper"><a
                                            href="{{ route('recruteurs.offres.show', $offre) }}">{{ $offre->titre }}</a>
                                    </h3>
                                    <h4 class="post-society text-upper"><a
                                            href="{{ route('recruteurs.offres.show', $offre) }}">{{ $offre->entreprise }}</a>
                                    </h4>
                                    <p class="local-icon">
                                ...
                                <div class="col-2 d-flex justify-content-center align-items-center icons">
                                    <a href="{{ route('recruteurs.offres.show', $offre) }}"><i
