        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                ...
                <div class="ms-md-auto py-2 py-md-0">
                    <a href="{{ route('recruteurs.offres.index') }}" class="btn btn-success btn-round me-2">Offres</a>
                    <a href="{{ route('recruteurs.profils.index') }}" class="btn btn-primary btn-round">Profils</a>
                </div>
            </div>
            <div class="row">
