    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('candidats.profils.store') }}">
                    @csrf
                    <div class="mb-3">
                        <div class="row">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <textarea name="descriptionProfil" class="form-control" id="" placeholder="Description" cols="20" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
