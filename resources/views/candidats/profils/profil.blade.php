...
@section('content-section')
    <div class="container profil">
        <div class="page-inner">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="container profil-content">
                        ...
                        @include('candidats.profils.edit', $user->profil)
                        @include('candidats.profils.show')                    
                        @endif
             ...
             <!-- The Modal -->
             @include('candidats.profils.create')
                        ...
                        @foreach ($user->formations as $formation)
                            <div class="row">
                                ...
                                <div class="col-lg-2 d-flex justify-content-center align-items-center">
                                    ...
                                    @include('candidats.formations.edit', $formation)
                                    <a href="" class="icon-link" data-bs-toggle="modal"
                                        data-bs-target="#showFormation-{{ $formation->id }}">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    @include('candidats.formations.show')
                                    <form action="{{ route('candidats.formations.destroy', $formation) }}" method="post">
                                        @csrf
                                        <button type="submit" class="icon-link" onclick="return confirm('Voulez-vous vraiment supprimer cette formation ?');"><i class="fa-solid fa-trash"></i></button>
                                    </form>
                                </div>
                                <hr>
                            </div>
            ...
            <!-- The Modal -->
            @include('candidats.formations.create')
                        ...
                        @foreach ($user->experiences as $experience)
                            <div class="row">
                                ...
                                <div class="col-lg-2 d-flex justify-content-center align-items-center">
                                    ...
                                    @include('candidats.experiences.edit', $experience)
                                    <a href="" class="icon-link" data-bs-toggle="modal"
                                        data-bs-target="#showExperience-{{ $experience->id }}">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    @include('candidats.experiences.show')
                                    <form action="{{ route('candidats.experiences.destroy', $experience) }}"
                                        method="post">
                                        @csrf
                                        <button type="submit" class="icon-link" onclick="return confirm('Voulez-vous vraiment supprimer cette experience ?');"><i class="fa-solid fa-trash"></i></button>
                                    </form>
                                </div>
                                <hr>
                            </div>
            ...
            <!-- The Modal -->
            @include('candidats.experiences.create')
