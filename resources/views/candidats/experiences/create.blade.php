    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('candidats.experiences.store') }}">
                    @csrf
                    <div class="mb-3">
                        <div class="row">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <textarea name="descriptionExperience" class="form-control" id="" placeholder="Description" cols="30" rows="10"></textarea>
                                {{-- <div id="editor"></div> <!-- Éditeur Quill -->
                                <input type="hidden" name="descriptionExperience"
                                    id="hidden-description"><!-- Stocke le HTML --> --}}
                            </div>
                        </div>
                    </div>
