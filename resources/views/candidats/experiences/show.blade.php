        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container experience-content">
                    <div class="row">
                        <div class="col-lg-5">
                            <p>{{ $experience->moisDebut }} {{ $experience->anneeDebut }} -
                                {{ $experience->moisFin }} {{ $experience->anneeFin }}</p>
                    ...
                    <div class="d-flex">
                        <a href="{{ route('candidats.experiences.edit', $experience) }}"
                            class="btn btn-primary mr-1" data-bs-toggle="modal" data-bs-target="#editExperience-{{ $experience->id }}">Editer</a>
                            @include('candidats.experiences.edit', $experience)
                        <form action="{{ route('candidats.experiences.destroy', $experience) }}" method="post">
                            @csrf
