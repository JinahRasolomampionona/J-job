        ...
        <div class="row gy-4 my-2">
            ...
            <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <article>
                    <div class="row">
                        <div class="col-10">
                            <h3 class="post-category text-upper"><a href="{{ route('candidats.offres.show', $offre) }}">{{ $offre->titre }}</a></h3>
                            <h4 class="post-society text-upper"><a href="{{ route('candidats.offres.show', $offre) }}">{{ $offre->entreprise }}</a></h4>
                            <p class="local-icon">
                        ...
                        <div class="col-2 d-flex justify-content-center align-items-center icons">
                            <a href="{{ route('candidats.offres.show', $offre) }}"><i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </article>
            </div>
