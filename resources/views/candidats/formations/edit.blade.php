    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('candidats.formations.update', $formation) }}">
                    @csrf
                    <div class="mb-3">
                        <div class="row">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <textarea name="descriptionFormation" class="form-control" id="" placeholder="Description" cols="30" rows="10">{{ $formation->descriptionFormation }}</textarea>
                            </div>
                        </div>
                    </div>
